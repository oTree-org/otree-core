...
## This new get_ROOM_DICT uses the RoomsStorage model where all Rooms are stored according to users
def get_room_dict():
        roomModel = list(RoomsStorage.objects.values('name', 'display_name'))
