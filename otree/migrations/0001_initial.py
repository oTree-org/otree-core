    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_in_previous_subsession_object_id', otree.db.models.PositiveIntegerField(null=True)),
                ('_in_next_subsession_object_id', otree.db.models.PositiveIntegerField(null=True)),
                ('subsession_object_id', otree.db.models.PositiveIntegerField(null=True)),
                ('_in_next_subsession_content_type', models.ForeignKey(related_name='otree_experimenter_next', to='contenttypes.ContentType', null=True)),
                ('_in_previous_subsession_content_type', models.ForeignKey(related_name='otree_experimenter_previous', to='contenttypes.ContentType', null=True)),
